...
EXPERIMENT_NAME = "UNET_WITH_RESIDUAL_CLASSIFICATION_REFINE_DATA_1_CLASSIFICATION"

CHECK_POINT_MASK_NAME = "UNET_WITH_RESIDUAL_CLASSIFICATION_REFINE_DATA_1.pth.tar"
