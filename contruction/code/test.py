...
from utils import get_test_loader, load_checkpoint, save_predictions_as_imgs, check_dev_performance
...
if __name__ == "__main__":
    ...
    acc = check_dev_performance(test_loader, model, device=DEVICE)
    print(acc)
